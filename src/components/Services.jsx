...
const ServicePage = () => {
  return (
    <div className="bg-gradient-to-r dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 text-gray-900 dark:text-white py-10 px-5 md:px-10 lg:px-20 mt-20 font-cormorant">
      <div className="max-w-7xl mx-auto">
        <header className="text-center mb-10">
          <h1 className="text-4xl md:text-5xl font-extrabold text-c9ab81 mb-4 animate-fade-in">Sri Ranga Tanjore Art Gallery</h1>
          <p className="text-xl md:text-2xl font-semibold animate-slide-in">Celebrating a Legacy of Artistic Excellence</p>
        </header>

        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold text-c9ab81 mb-4 animate-fade-in">Our Offerings</h2>
          <p className="mb-4 animate-slide-in">
          ...
          <h3 className="text-xl font-semibold mb-2 animate-fade-in">Painting Sizes and Pricing:</h3>
          <ul className="list-disc list-inside mb-4 animate-slide-in">
          ...
          <h3 className="text-xl font-semibold mb-2 animate-fade-in">Customization:</h3>
          <p className="animate-slide-in">
        ...
        <section className="mb-10">
          <h2 className="text-2xl md:text-3xl font-bold text-c9ab81 mb-4 animate-fade-in">Contact Us for Custom Orders</h2>
        ...
        <footer className="text-center mt-10 animate-fade-in">
          <h2 className="text-2xl font-bold text-c9ab81 mb-4">For Orders and Enquiries:</h2>
